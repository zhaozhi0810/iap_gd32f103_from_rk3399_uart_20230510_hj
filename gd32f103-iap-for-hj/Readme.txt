...
七、2023-05-11
1.对软件进行了一些梳理，安装dg-iic的版本进行了一些改进。
2.增加了md5的计算的功能。



八、2023-06-08
1. secCRT ymodem发送的帧是128字节大小，已经调好调试串口下载合并的bin文件的情况了。会自动丢弃前24k字节。
2.对于超过32k字节的时候，请注意ymodem发送的时候序号又会从0开始。
3.目前已经验证调试串口下载和3399串口下载了。
